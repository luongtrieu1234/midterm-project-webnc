        ...
        <div className='grid'>
          <div className='col-12 md:col-6 mb-4 px-5'>
            ...
            <span className='text-700 line-height-3'>
              The system was installed and deployed by a team consisting of members: Le Xuan Tien,
              Tran Minh Tri and Luong Van Trieu. The system offers the most famous and best courses
              on the market today. Associated with many companies all over the world.
            </span>
            <br></br>
            <br></br>
